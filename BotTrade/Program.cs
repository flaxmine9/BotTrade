    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            client.AddStrategy(new StrategyCPR
                (
                   new TradeSetting(takeProfit: 1.05m, stopLoss: 1.025m, leverage: 5, futuresMarginType: "Isolated"),
            ...
            //Client clientKirill = new Client(new ApiSetting() { Key = keyTestKirill, SecretKey = secretKeyTestKirill });
            //clientKirill.AddStrategy(new StrategyCPR
            //    (
            //       new TradeSetting(takeProfit: 1.05m, stopLoss: 1.025m, leverage: 5, futuresMarginType: "Isolated"),
            //       new PivotPoint(new Traditional())
